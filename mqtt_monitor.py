#!/usr/bin/env python3
"""
MQTT Monitor Utility for EV-Meter

This utility subscribes to all MQTT topics on the EV-Meter broker and:
1. Attempts to parse any received payloads using the evmeter-client parser
2. If parsing succeeds, displays both raw and parsed data
3. If parsing fails, displays only the raw data

Usage:
    python mqtt_monitor.py

The utility will connect to the default EV-Meter MQTT broker and display
all traffic, helping with debugging and understanding the protocol.
"""
